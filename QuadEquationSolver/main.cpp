// A Small program for solving quadratic equations for real roots.
// Input: An "input.txt" text file located at ".../QuadEquationSolver/" formatted like this: "x y z", where x, y, z are equation coefficients in double.
